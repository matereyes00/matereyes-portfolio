...
function Home() {
	...
	const pub_titles = [
		...
		"I-HOPE: DEVELOPMENT OF AN INTELLIGENT HEALTH FACILITY OPTIMIZER AND RECOMMENDER SYSTEM FOR OPTIMAL PLACEMENT OF RURAL HEALTH UNITS IN A REGION",
	];
	const pub_date = [
		"December 2, 2023",
		"December 2, 2023",
	...
	const pub_article_urls = [
		...
		"https://drive.google.com/file/d/1DK1gzMw3peN7kZDOd-UGfFbfjEvFqNrv/view",
		// "",
	];
	const pub_descriptions = [
		...
		"The 7th Graduate Research Festival is a celebration of all graduate students who present their completed their masteral or doctorate studies.",
	];
	const embeds = [
		<></>,
		<></>,
