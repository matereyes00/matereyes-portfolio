...
const EventText = () => { 
    ...
    return (
        <>
            <div className='flex flex-row mx-10 my-12 bg-[#8d5e9b] bg-opacity-80 text-[#ddd7e1] p-5'>
            ...
            <div className='flex flex-row mx-10 my-10 bg-[#c2a8ca] bg-opacity-80 p-5 text-right'>
            ...
            <div className='flex flex-row mx-10 my-10 bg-[#8d5e9b] text-[#ddd7e1] bg-opacity-80 p-5 text-left'>
                <p className='my-auto'>
