    ...
    return (
        <>
            ...
            <div className='flex flex-row mx-10 my-10 bg-[#c2a8ca] bg-opacity-80 p-5'>
                <img src={compsat_workshop} alt='Ateneo Graduation 2023' className='h-50 w-40'/>
                <p className='my-auto'>{content2}</p>
            </div>
            <FontAwesomeIcon icon={faLocationDot} size="3x" style={{ color: 'white' }}/>
            <div className='flex flex-row mx-10 my-10 bg-[#8d5e9b] bg-opacity-80 p-5'>
                <p className='my-auto'>{content3_1}</p>
                <img src={compsat_dp} alt="CompSAt 2021 FB DP" className='w-50 h-40'/>
            </div>
            ...
            <div className='flex flex-row mx-10 my-10 bg-[#8d5e9b] bg-opacity-80 p-5'>
                ...
                <img src={ico_ph} alt='ICOPH 2024 Conference' className='h-50 w-40'/>
            </div>
            <FontAwesomeIcon icon={faLocationDot} size="3x" style={{ color: 'white' }}/>
            <div className='flex flex-row mx-10 my-10 bg-[#c2a8ca] bg-opacity-80 p-5'>
                <img src={ubx_ps} alt='UBX Photoshoot' className='h-50 w-40'/>
